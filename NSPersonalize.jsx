    ...
    <div className="personalizecontainer">
      ...
      <div className="controllize-container">
        <div id="buttonscontrol">
          ...
          />
          <div id="customizediv">
            <button className="del-btn" title="delete" onClick={handleDeleteImage}>
            <i className="fa-solid fa-trash" />            </button>
            <button
              className="zoom-in" title="zoom in"
              onClick={() => updateTransform("scale", 0.1)}
            >
              <i className="fa-solid fa-magnifying-glass-plus" />
              </button>
            <button title="zoom out" onClick={() => updateTransform("scale", -0.1)}>
            <i className="fa-solid fa-magnifying-glass-minus" />
            </button>
            <button title="tilt left" onClick={() => updateTransform("rotate", 10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title="tilt right" onClick={() => updateTransform("rotate", -10)}>
            <i className="fa-solid fa-right-long" />
            </button>
            <button title="upside down" onClick={() => updateTransform("rotate", 180)}>
            <i className="fa-solid fa-arrows-up-down" />
            </button>
            <button title="up" onClick={() => updateTransform("translateY", -10)}>
            <i className="fa-solid fa-up-long" />
            </button>
            <button title="down" onClick={() => updateTransform("translateY", 10)}>
            <i className="fa-solid fa-down-long" />
            </button>
            <button title="left" onClick={() => updateTransform("translateX", -10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title="right" onClick={() => updateTransform("translateX", 10)}>
            <i className="fa-solid fa-right-long" />
            </button>
        ...
        <div className="student-details">
          ...
          <div id="namecustomizediv">
            ...
            <button title="zoom out" onClick={() => updateTransforminput("scale", -0.1)}>
              <i className="fa-solid fa-magnifying-glass-minus" />
            </button>
            <button title='tilt left' onClick={() => updateTransforminput("rotate", 10)}>
              <i className="fa-solid fa-left-long" />
            </button>
            <button title='tilt right' onClick={() => updateTransforminput("rotate", -10)}>
              <i className="fa-solid fa-right-long" />
            </button>
            <button title='upside down' onClick={() => updateTransforminput("rotate", 180)}>
            <i className="fa-solid fa-arrows-up-down" />
            </button>
            <button title='up' onClick={() => updateTransforminput("translateY", -10)}>
              <i className="fa-solid fa-up-long" />
            </button>
            <button title='down' onClick={() => updateTransforminput("translateY", 10)}>
            <i className="fa-solid fa-down-long" />
            </button>
            <button title='left' onClick={() => updateTransforminput("translateX", -10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title='right' onClick={() => updateTransforminput("translateX", 10)}>
            <i className="fa-solid fa-right-long" />
            </button>
          </div>
          <img
          ...
          <div id="schoolnamecustomizediv">
            ...
            <button title='zoom out' onClick={() => updatetransformschool("scale", -0.1)}>
              <i className="fa-solid fa-magnifying-glass-minus" />
            </button>
            <button title='tilt left' onClick={() => updatetransformschool("rotate", 10)}>
              <i className="fa-solid fa-left-long" />
            </button>
            <button title='tilt right' onClick={() => updatetransformschool("rotate", -10)}>
              <i className="fa-solid fa-right-long" />
            </button>
            <button title='updise down' onClick={() => updatetransformschool("rotate", 180)}>
              <i className="fa-solid fa-arrows-up-down" />
            </button>
            <button title='up' onClick={() => updatetransformschool("translateY", -10)}>
              <i className="fa-solid fa-up-long" />
            </button>
            <button title='down ' onClick={() => updatetransformschool("translateY", 10)}>
              <i className="fa-solid fa-down-long" />
            </button>
            <button title='left' onClick={() => updatetransformschool("translateX", -10)}>
              <i className="fa-solid fa-left-long" />
            </button>
            <button title='right' onClick={() => updatetransformschool("translateX", 10)}>
               <i className="fa-solid fa-right-long" />
            </button>
          </div>
          <img
          ...
          <div className='img-cus'>
            ...
            <button title='zoom in' onClick={() => updatetransformsubject("scale", -0.1)}>
            <i className="fa-solid fa-magnifying-glass-minus" />
            </button>
            <button title='zoom out' onClick={() => updatetransformsubject("rotate", 10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title='tilt left' onClick={() => updatetransformsubject("rotate", -10)}>
            <i className="fa-solid fa-right-long" />
            </button>
            <button title='upside down' onClick={() => updatetransformsubject("rotate", 180)}>
            <i className="fa-solid fa-arrows-up-down" />
            </button>
            <button title='up' onClick={() => updatetransformsubject("translateY", -10)}>
            <i className="fa-solid fa-up-long" />
            </button>
            <button title='down' onClick={() => updatetransformsubject("translateY", 10)}>
            <i className="fa-solid fa-down-long" />
            </button>
            <button title='left' onClick={() => updatetransformsubject("translateX", -10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title='right' onClick={() => updatetransformsubject("translateX", 10)}>
            <i className="fa-solid fa-right-long" />
            </button>
          </div>
            ...
            <button title='zoom out' onClick={() => updatetransformrollno("scale", -0.1)}>
            <i className="fa-solid fa-magnifying-glass-minus" />
            </button>
            <button title='tilt left' onClick={() => updatetransformrollno("rotate", 10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title='tilt right' onClick={() => updatetransformrollno("rotate", -10)}>
            <i className="fa-solid fa-right-long" />
            </button>
            <button title='upside down' onClick={() => updatetransformrollno("rotate", 180)}>
            <i className="fa-solid fa-arrows-up-down" />
            </button>
            <button title='up' onClick={() => updatetransformrollno("translateY", -10)}>
            <i className="fa-solid fa-up-long" />
            </button>
            <button title='down' onClick={() => updatetransformrollno("translateY", 10)}>
            <i className="fa-solid fa-down-long" />
            </button>
            <button title='left' onClick={() => updatetransformrollno("translateX", -10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title='right' onClick={() => updatetransformrollno("translateX", 10)}>
            <i className="fa-solid fa-right-long" />
            </button>
          </div>
            <img
            ...
            <button title='zoom out' onClick={() => updatetransformsection("scale", -0.1)}>
            <i className="fa-solid fa-magnifying-glass-minus" />
            </button>
            <button title='tilt left' onClick={() => updatetransformsection("rotate", 10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title='tilt right' onClick={() => updatetransformsection("rotate", -10)}>
            <i className="fa-solid fa-right-long" />
            </button>
            <button title='upside down' onClick={() => updatetransformsection("rotate", 180)}>
            <i className="fa-solid fa-arrows-up-down" />
            </button>
            <button title='up' onClick={() => updatetransformsection("translateY", -10)}>
            <i className="fa-solid fa-up-long" />
            </button>
            <button title='down' onClick={() => updatetransformsection("translateY", 10)}>
            <i className="fa-solid fa-down-long" />
            </button>
            <button title='left' onClick={() => updatetransformsection("translateX", -10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title='right' onClick={() => updatetransformsection("translateX", 10)}>
            <i className="fa-solid fa-right-long" />
            </button>
          </div>
            <img
            ...
            <button title='zoom out' onClick={() => updatetransformclass("scale", -0.1)}>
            <i className="fa-solid fa-magnifying-glass-minus" />
            </button>
            <button title='tilt left' onClick={() => updatetransformclass("rotate", 10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title='tilt right' onClick={() => updatetransformclass("rotate", -10)}>
            <i className="fa-solid fa-right-long" />
            </button>
            <button title='upside down' onClick={() => updatetransformclass("rotate", 180)}>
            <i className="fa-solid fa-arrows-up-down" />
            </button>
            <button title='up' onClick={() => updatetransformclass("translateY", -10)}>
            <i className="fa-solid fa-up-long" />
            </button>
            <button title='down' onClick={() => updatetransformclass("translateY", 10)}>
            <i className="fa-solid fa-down-long" />
            </button>
            <button title='left' onClick={() => updatetransformclass("translateX", -10)}>
            <i className="fa-solid fa-left-long" />
            </button>
            <button title='right' onClick={() => updatetransformclass("translateX", 10)}>
            <i className="fa-solid fa-right-long" />
            </button>
            </div>
            <img
          ...
          Quantity
            ...
            <label id="price">Rs.{product.price * quantity}</label>
